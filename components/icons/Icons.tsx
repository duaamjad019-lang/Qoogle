...
export const FireIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 16.121A5 5 0 0012.014 13m2.828-2.828A5 5 0 0013 9.014m-2.828 2.828A5 5 0 019.014 13" />
  </svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-9l2.293 2.293a1 1 0 01-1.414 1.414L10 10m0 0l-2.293 2.293a1 1 0 01-1.414-1.414L10 10m0 0l2.293-2.293a1 1 0 011.414 1.414L10 10m0 0l-2.293-2.293a1 1 0 011.414-1.414L10 10m6-3l2.293 2.293a1 1 0 01-1.414 1.414L16 13m0 0l-2.293 2.293a1 1 0 01-1.414-1.414L16 13m0 0l2.293-2.293a1 1 0 011.414 1.414L16 13m0 0l-2.293-2.293a1 1 0 011.414-1.414L16 13" />
    </svg>
);
...
export const HeartIcon: React.FC<{ className?: string, fill?: string }> = ({ className, fill='none' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill={fill} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
